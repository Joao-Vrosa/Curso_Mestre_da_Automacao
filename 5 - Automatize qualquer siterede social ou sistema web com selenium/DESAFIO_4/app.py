# Desafios 4
# Digite um texto grande no campo abaixo, digitando em uma velocidade humana
...
elemento = driver.find_element(By.XPATH, '//textarea[@id="campoparagrafo"]')

digitar_naturalmente(texto, elemento)
